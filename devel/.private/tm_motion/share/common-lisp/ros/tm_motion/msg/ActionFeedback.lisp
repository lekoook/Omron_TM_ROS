...
(cl:defmethod cl:initialize-instance :after ((m <ActionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tm_motion-msg:<ActionFeedback> is deprecated: use tm_motion-msg:ActionFeedback instead.")))

(cl:ensure-generic-function 'received_data-val :lambda-list '(m))
(cl:defmethod received_data-val ((m <ActionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tm_motion-msg:received_data-val is deprecated.  Use tm_motion-msg:received_data instead.")
  (received_data m))
