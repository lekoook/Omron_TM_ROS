...
let ActionGoal = require('./ActionGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ActionActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ActionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ActionGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ActionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ActionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ActionGoal()
    }
...
module.exports = ActionActionGoal;
