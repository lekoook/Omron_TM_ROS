...
struct MD5Sum< ::tm_motion::ActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "d026b0c3503b37f6876f367f2288888a";
  }

  static const char* value(const ::tm_motion::ActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd026b0c3503b37f6ULL;
  static const uint64_t static_value2 = 0x876f367f2288888aULL;
};
