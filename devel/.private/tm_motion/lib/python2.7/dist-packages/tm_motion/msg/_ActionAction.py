...
class ActionAction(genpy.Message):
  _md5sum = "47eff205a59172188654e9a07989cd10"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.goal_goal
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.goal_goal = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.goal_goal = str[start:end]
      _x = self
      start = end
      end += 12
