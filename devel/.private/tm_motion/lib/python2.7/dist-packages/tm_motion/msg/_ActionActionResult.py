...
"""autogenerated by genpy from tm_motion/ActionActionResult.msg. Do not edit."""
import sys
...
class ActionActionResult(genpy.Message):
  _md5sum = "9837ccbad3be3688f11b9241755315de"
  _type = "tm_motion/ActionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tm_motion/ActionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ActionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tm_motion.msg.ActionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tm_motion.msg.ActionResult()
