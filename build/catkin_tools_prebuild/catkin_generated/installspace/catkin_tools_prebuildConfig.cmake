...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tthmatt/Omron-TM-ROS/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tthmatt/Omron-TM-ROS/install/lib;/home/tthmatt/Omron_LD_ROS_Package/devel/lib;/home/tthmatt/ws/devel/lib;/home/tthmatt/catkin_ws/devel/lib;/opt/ros/melodic/lib)
